...
__appname__ = 'LOGIC_IMG_ANNO_XML'  # LOGIC

PROJECT_ID = 4

if 0 == PROJECT_ID:
    name_label_file = 'predefined_classes.txt'
elif 1 == PROJECT_ID:
    name_label_file = 'predefined_classes.txt'
elif 2 == PROJECT_ID:
    name_label_file = 'predefined_classes.txt'
    ...
    name_label_file = 'predefined_classes.txt'
    print 'use default name_label_file ---> predefined_classes.txt'
...
class MainWindow(QMainWindow, WindowMixin):
    ...
    def scanAllImages(self, folderPath):
        ...
        extensions = ['.jpg']  # LOGIC
        images = []

        for root, dirs, files in os.walk(folderPath):
            if root != folderPath:  # LOGIC
                break
            for file in files:
    ...
    def loadPredefinedClasses(self):
        ...
        predefined_classes_path = os.path.join('data', name_label_file)  # LOGIC
